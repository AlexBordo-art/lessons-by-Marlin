                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                           <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                            ...
                            <?php foreach ($box as $i):?>
                            <div class="<?php echo $i["ban"] ? "banned" : "" ;?> rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                <img src="<?php echo $i["foto"];?>" alt="<?php echo $i["name"];?>" class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                <div class="ml-2 mr-3">
                                    <h5 class="m-0">
                                    <?php echo $i["name"];?>
                                    ...
                                    <a href="<?php echo $i["twitter"];?>" class="text-info fs-sm" target="_blank"><?php echo $i["nick"];?></a> 

                                    -
                                    <a href="<?php echo $i["wrapbootstrap"];?>" class="text-info fs-sm" target="_blank" title="<?php echo $i["name"];?>"><i class="fal fa-envelope"></i></a>
                                </div>
                            </div>
                            <?php endforeach;?>
                            </div>
